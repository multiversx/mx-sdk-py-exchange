...
from tools.runners.common_runner import ExportedAccount, ExportedToken, add_contract_group_parser,\
    add_generate_transaction_command, add_upgrade_command, add_verify_command,\
      fund_shadowfork_accounts, get_acounts_with_token, get_default_signature, read_accounts_from_json,\
        resolve_upgrade_bytecode, run_verify_command, sync_account_nonce, write_accounts_to_json
...
from utils.utils_chain import Account, WrapperAddress, decode_merged_attributes, base64_to_hex, dec_to_padded_hex, hex_to_base64
...
def upgrade_energy_factory(args: Any):
    ...
    bytecode_path = resolve_upgrade_bytecode(args.bytecode, config.SIMPLE_LOCK_ENERGY_BYTECODE_PATH,
